...
public class AsignacionesPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        JLabel lblTitulo = new JLabel("Asignaciones");
        lblTitulo.setFont(new Font("Serif", Font.BOLD, 22));
        lblTitulo.setForeground(TEXT_TITLE);
        
        JLabel lblSub = new JLabel("Consulta las relaciones entre empleados y proyectos");
        ...
        // ── FILTROS ─────────────────────────────────────────────
        txtBuscar = styledField(20);
        txtBuscar.setToolTipText("Buscar por empleado, proyecto o rol...");
        ...
        modelo.setColumnIdentifiers(new String[]{
            "ID Empleado", "Nombre", "Apellido", "Proyecto", "Rol", "Horas Asignadas"});
